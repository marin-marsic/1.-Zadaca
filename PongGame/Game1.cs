...
namespace PongGame
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            PaddleBottom.Position = new Vector2((screenBounds.Right- PaddleBottom.Size.Width)/2, screenBounds.Bottom-PaddleBottom.Size.Height);
            PaddleTop.Position = new Vector2((screenBounds.Right - PaddleTop.Size.Width) / 2, screenBounds.Top);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            // singleplayer
            //PaddleTop.Position.X = Ball.Position.X - PaddleTop.Size.Width / 2;
